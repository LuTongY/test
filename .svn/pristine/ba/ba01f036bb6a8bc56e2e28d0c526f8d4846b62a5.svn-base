...
<template>
      ...
      <el-footer>
	   ...
	   <tree ref='tree' :select_id="select_id"/>
   </el-container>
</template>
<script>
	import page from '@/components/page/page.vue'
	import add from './add_edit.vue'
	import tree from './permissionTree.vue'
	export default {
		name: "user_list",
		components: {
			page,
		...
		methods: {
			page_list: function() {
				...
				this.api.user_list.get_GetList(pagesize,page,this.user).then((res) => {
