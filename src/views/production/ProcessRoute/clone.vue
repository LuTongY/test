<template>
   <div v-dialogdrag>
    <el-dialog v-model="is_show" width="1200px" title="复制工序路线"  destroy-on-close top='7vh'>
      <el-row>
        <el-col :span="11">
...
export default {
  ...
  methods: {
    ...
    submitForm(){
      this.api.production.ProcessRoute.Copy(this.radioForm.code,this.Version,this.items,).then((res)=>{
                  if(res.data.code==200){
